# %%CELL 1%%
# Setup & Dependencies
!pip install requests numpy matplotlib tqdm
...
# CONFIGURATION
# ==========================================
# IMPORTANT: Replace YOUR_USERNAME with your HuggingFace Space username
...
# %%CELL 6%%
# Graph Generation & Smoothing Logic
...
# %%CELL 7%%
# Display Summary Table and Inline Graph
print("\\n================================================")
...
plt.show()
display(Image("outputs/evals/red_vs_blue_curve.png"))
